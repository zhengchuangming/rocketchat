...
const resolver = {
	Query: {
		messages: authenticated((root, args, { user }) => {
			...
			if (channel) {
				console.log("const cursorMsg = RocketChat.models.Messages.findOne(args.cursor, { fields: { ts: 1 } });");
				// cursor
				...
				console.log("onst messages = RocketChat.models.Messages.find(messagesQuery, messagesOptions);");
